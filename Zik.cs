...
namespace Idf
{
    public class Zik : AttackUnits
    {
        public class Builder
        {
            public Zik initUnit = new Zik();
            ...
            {
                initUnit.MaximumArmaments = 3;
                initUnit.EffectiveAgainst.Add(initUnit.Locations[1]);
                initUnit.EffectiveAgainst.Add(initUnit.Locations[2]);
                return initUnit;
            }
        }
    }
